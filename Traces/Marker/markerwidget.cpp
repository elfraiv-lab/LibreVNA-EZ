    ...
    model(model)
{
    ...
    ui->treeView->setColumnWidth(MarkerModel::ColIndexType, Theme::isTablet() ? 230 : 180);
    ui->treeView->setColumnWidth(MarkerModel::ColIndexRestrict, Theme::isTablet() ? 440 : 340);
