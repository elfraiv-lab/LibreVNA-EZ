...
// row height follows the theme control height so persistent editors (combobox, SIUnitEdit) are not clipped
static int rowHeight() { return Theme::controlHeight() + 2; }
