...
public:
    ...
    // Limit the displayed digits after the decimal point (-1 = no limit). Editing still starts from the full value.
    void setMaxDecimals(int decimals) { this->maxDecimals = decimals; setValueQuiet(_value); }
